...
This repository is in **Application Implementation**. The authorized implementation boundary covers the **Opportunity Work Images vertical slice (Slice 1A)**, the **Site Survey Vertical Slice (Slice 4)**, the **Official Estimate BOQ & Calculation Vertical Slice (Slice 5A)**, the **Commercial Quotation Vertical Slice (Slice 5B)**, and the **Item Master Estimate Catalog Vertical Slice** documented in `docs/superpowers/plans/2026-09-18-official-estimate-boq-calculation-vertical-slice.md`, `docs/superpowers/plans/2026-09-20-commercial-quotation-vertical-slice.md`, `docs/superpowers/plans/2026-09-22-item-master-estimate-catalog-completion.md`, `docs/05-engineering/official-estimate-verification.md`, `docs/05-engineering/commercial-quotation-verification.md`, and `docs/05-engineering/item-master-estimate-catalog-verification.md` (hardening under `docs/superpowers/plans/2026-09-20-official-estimate-commercial-hardening.md`). This boundary covers multi-image work photo attachment for Open Opportunities, site survey appointment scheduling, surveying stage transitions, survey workspace with areas/measurements/notes, survey revision readiness gates (Mark Ready) with snapshot hashing, automatic progression to estimating stage, official estimate draft creation, BOQ workspace drawer (sections, work items, cost components), real-time pricing rules, official calculation engine with discount, VAT 7%, and calculation snapshots, commercial quotation issuance, customer acceptance, opportunity progression to proposed and won, document sequence configuration, and item master catalog with versioned cost records and authoritative estimate snapshots. Customer lifecycle transitions beyond activation, Site edit/deactivation, quotation amendment, quotation void/cancel, quotation PDF/printing/signatures, external customer acceptance portal, Project, Procurement, Inventory, Production, and MRP behavior remain deferred without a separately approved implementation task.
