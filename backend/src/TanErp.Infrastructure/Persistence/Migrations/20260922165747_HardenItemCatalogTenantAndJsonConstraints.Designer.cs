...
namespace TanErp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260922165747_HardenItemCatalogTenantAndJsonConstraints")]
    partial class HardenItemCatalogTenantAndJsonConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TanErp.Domain.Common.AuditEvent", b =>
                {
                    ...
                    b.Property<Guid?>("RowVersionAfter")
                        .HasColumnType("uuid")
                        .HasColumnName("row_version_after");

                    b.Property<Guid?>("RowVersionBefore")
                        .HasColumnType("uuid")
                        .HasColumnName("row_version_before");
                    ...
                    b.HasIndex("OrganizationId", "ResourceType", "ResourceId", "OccurredAtUtc");
            ...
            modelBuilder.Entity("TanErp.Domain.Estimates.EstimateCostComponent", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CostEffectiveFromUtc")
                        .HasColumnType("timestamptz")
                    ...
                    b.Property<string>("CostPolicyVersion")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("cost_policy_version");

                    b.Property<Guid?>("CostRecordId")
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CostScopeSnapshot")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                    ...
                    b.HasIndex("CostRecordId", "OrganizationId");
            ...
            modelBuilder.Entity("TanErp.Domain.Files.FileUploadSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("CreationIntentId")
                        .HasColumnType("uuid")
                        .HasColumnName("creation_intent_id");
                    ...
                    b.HasIndex("OrganizationId", "CreationIntentId")
                        .HasDatabaseName("ix_file_upload_sessions_creation_intent");

                    b.HasIndex("OrganizationId", "CreatedByUserId", "IdempotencyKeyHash")
                        .IsUnique()
                    ...
                    b.ToTable("file_upload_sessions", (string)null);
                });
            ...
            modelBuilder.Entity("TanErp.Domain.Files.FileUploadSlot", b =>
                {
                    ...
                    b.ToTable("file_upload_slots", (string)null);
                });
                    ...
                    b.ToTable("uploaded_files", "files", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_uploaded_files_scan_status", "scan_status IN ('content_verified', 'clean', 'pending', 'infected')");
            ...
            modelBuilder.Entity("TanErp.Domain.Items.CostRecord", b =>
                {
                    ...
                    b.Property<Guid?>("CostSourceId")
                        .HasColumnType("uuid")
                        .HasColumnName("cost_source_id");
                    ...
                    b.Property<Guid?>("EvidenceFileId")
                        .HasColumnType("uuid")
                        .HasColumnName("evidence_file_id");

                    b.Property<Guid>("ItemId")
                        .HasColumnType("uuid")
                        .HasColumnName("item_id");

                    b.Property<Guid>("LastFinancialEditorId")
                        .HasColumnType("uuid")
                        .HasColumnName("last_financial_editor_id");
                    ...
                    b.HasIndex("CostSourceId", "OrganizationId");

                    b.HasIndex("EvidenceFileId", "OrganizationId");

                    b.HasIndex("ItemId", "OrganizationId");

                    b.HasIndex("UnitId", "OrganizationId");

                    b.HasIndex("OrganizationId", "ItemId", "Scope", "BranchId", "Status");

                    b.HasIndex("OrganizationId", "ItemId", "Status", "Currency", "UnitId", "EffectiveFromUtc");
            ...
            modelBuilder.Entity("TanErp.Domain.Items.CostRecordReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AuthoritySnapshot")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("authority_snapshot");
                    ...
                    b.HasIndex("OrganizationId", "CostRecordId", "DecidedAtUtc");

                    b.ToTable("cost_record_reviews", "item_master", t =>
                        {
                            t.HasCheckConstraint("CK_cost_record_reviews_decision", "decision IN ('approved', 'returned')");
                        });
                });

            modelBuilder.Entity("TanErp.Domain.Items.CostSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TanErp.Domain.Items.Item", b =>
                {
                    ...
                    b.Property<bool>("ActivatedOnce")
                        .HasColumnType("boolean")
                        .HasColumnName("activated_once");
                    ...
                    b.Property<DateTimeOffset?>("InactiveAtUtc")
                        .HasColumnType("timestamptz")
                        .HasColumnName("inactive_at_utc");

                    b.Property<Guid?>("InactiveByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("inactive_by_user_id");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Capabilities", "TanErp.Domain.Items.Item.Capabilities#ItemCapabilities", b1 =>
                        {
                            b1.IsRequired();

                            b1.Property<bool>("CanCost")
                                .HasColumnType("boolean")
                                .HasColumnName("can_cost");

                            b1.Property<bool>("CanProduce")
                                .HasColumnType("boolean")
                                .HasColumnName("can_produce");

                            b1.Property<bool>("CanPurchase")
                                .HasColumnType("boolean")
                                .HasColumnName("can_purchase");

                            b1.Property<bool>("CanSell")
                                .HasColumnType("boolean")
                                .HasColumnName("can_sell");

                            b1.Property<bool>("CanStock")
                                .HasColumnType("boolean")
                                .HasColumnName("can_stock");
                        });

                    b.HasKey("Id");

                    b.HasIndex("BaseUnitId", "OrganizationId");

                    b.HasIndex("BrandId", "OrganizationId");

                    b.HasIndex("CategoryId", "OrganizationId");

                    b.HasIndex("OrganizationId", "BaseUnitId");
                    ...
                    b.HasIndex("OrganizationId", "Status", "NormalizedCode");

                    b.ToTable("items", "item_master", t =>
                        {
            ...
            modelBuilder.Entity("TanErp.Domain.Items.ItemAlias", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("NormalizedEn")
                        .HasMaxLength(250)
                        .HasColumnType("character varying(250)")
                        .HasColumnName("normalized_en");

                    b.Property<string>("NormalizedTh")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("character varying(250)")
                        .HasColumnName("normalized_th");
                    ...
                    b.HasIndex("OrganizationId", "NormalizedEn");

                    b.HasIndex("OrganizationId", "NormalizedTh");

                    b.HasIndex("OrganizationId", "ItemId", "NormalizedEn")
                        .IsUnique()
                        .HasDatabaseName("ix_item_aliases_org_item_normalized_en")
                        .HasFilter("normalized_en IS NOT NULL");

                    b.HasIndex("OrganizationId", "ItemId", "NormalizedTh")
                        .IsUnique();

                    b.ToTable("item_aliases", "item_master", t =>
                        {
            ...
            modelBuilder.Entity("TanErp.Domain.Items.ItemBranchAvailability", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "ItemId", "BranchId")
                        .IsUnique();

                    b.ToTable("item_branch_availabilities", "item_master", t =>
                        {
            ...
            modelBuilder.Entity("TanErp.Domain.Items.ItemBrand", b =>
                {
                    ...
                    b.ToTable("item_brands", "item_master", t =>
                        {
            ...
            modelBuilder.Entity("TanErp.Domain.Items.ItemCategory", b =>
                {
                    ...
                    b.HasIndex("ParentCategoryId", "OrganizationId");

                    b.HasIndex("OrganizationId", "Status", "SortOrder", "Id");

                    b.ToTable("item_categories", "item_master", t =>
                        {
            ...
            modelBuilder.Entity("TanErp.Domain.Items.ItemImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OrganizationId", "ItemId", "FileId")
                        .IsUnique();

                    b.HasIndex("OrganizationId", "ItemId", "Status", "DisplayOrder", "Id");

                    b.ToTable("item_images", "item_master", t =>
                        {
            ...
            modelBuilder.Entity("TanErp.Domain.Estimates.EstimateCostComponent", b =>
                {
                    ...
                    b.HasOne("TanErp.Domain.Items.CostRecord", null)
                        .WithMany()
                        .HasForeignKey("CostRecordId", "OrganizationId")
                        .HasPrincipalKey("Id", "OrganizationId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("TanErp.Domain.Files.FileUploadSlot", b =>
                {
                    b.HasOne("TanErp.Domain.Files.FileUploadSession", null)
                        .WithMany("Slots")
            ...
            modelBuilder.Entity("TanErp.Domain.Items.CostRecord", b =>
                {
                    ...
                    b.HasOne("TanErp.Domain.Items.CostSource", "CostSource")
                        .WithMany()
                        .HasForeignKey("CostSourceId", "OrganizationId")
                        .HasPrincipalKey("Id", "OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("TanErp.Domain.Files.UploadedFile", null)
                        .WithMany()
                        .HasForeignKey("EvidenceFileId", "OrganizationId")
                        .HasPrincipalKey("Id", "OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("TanErp.Domain.Items.Item", b =>
                {
                    ...
                    b.HasOne("TanErp.Domain.Items.UnitOfMeasure", "BaseUnit")
                        .WithMany()
                        .HasForeignKey("BaseUnitId", "OrganizationId")
                        .HasPrincipalKey("Id", "OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TanErp.Domain.Items.ItemBrand", "Brand")
                        .WithMany()
                        .HasForeignKey("BrandId", "OrganizationId")
                        .HasPrincipalKey("Id", "OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("TanErp.Domain.Items.ItemCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("TanErp.Domain.Items.ItemCategory", b =>
                {
                    ...
                    b.HasOne("TanErp.Domain.Items.ItemCategory", "ParentCategory")
                        .WithMany("SubCategories")
                        .HasForeignKey("ParentCategoryId", "OrganizationId")
                        .HasPrincipalKey("Id", "OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict);
