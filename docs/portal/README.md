...
สูตรและกฎของ Node `work-template`, `measurement` และ `price-range` อ้างอิง [Quick Estimate Pricing Rules](../01-business/quick-estimate-pricing-rules.md) ส่วนการตัดสินก่อนแชร์อ้างอิง [Approval Matrix](../01-business/approval-matrix.md)
